...
- metadata에는 실제 `bending_warp_ui`, `bending_weft_ui`, raw/internal 값을 모두 기록한다.
...
| `fabric_sampler.preserve_bending_v2_ratio` | `true` | base fabric의 bending v2/primary 비율 유지 |
